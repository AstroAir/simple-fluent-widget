...
class FluentCard(QFrame):
    ...
    hover_progress = Property(float, _get_hover_progress, _set_hover_progress, None, "Hover animation progress")
    press_progress = Property(float, _get_press_progress, _set_press_progress, None, "Press animation progress")
    current_elevation = Property(float, _get_current_elevation, _set_current_elevation, None, "Current elevation level")
...
class ExpandableFluentCard(FluentCard):
    ...
    expandIconRotation = Property(float, _get_expand_icon_rotation, _set_expand_icon_rotation, None, "Expand icon rotation angle")
