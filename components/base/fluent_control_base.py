...
class FluentControlBase(FluentBaseWidget):
    ...
    def _setup_base_animations(self):
        ...
        self._state_animation = QPropertyAnimation(
    ...
    def _update_theme_tokens(self):
        ...
        self._theme_tokens = {
            ...
            "corner_radius": 4,  # Fallback value for corner radius
            "elevation": 2       # Fallback value for elevation
        }
    ...
    def cleanup(self):
        ...
        # Only call super().cleanup() if it exists
        cleanup_method = getattr(super(), "cleanup", None)
...
class FluentContainerBase(FluentControlBase):
    ...
    def set_padding(self, top: Optional[int] = None, right: Optional[int] = None,
                    bottom: Optional[int] = None, left: Optional[int] = None):
...
FluentWidget = Union[FluentControlBase,
                     FluentContainerBase, FluentNavigationBase]
