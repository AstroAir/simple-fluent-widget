...
class FluentFilterBar(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None, 
        ...
        # Create clear button
        self._clear_button = FluentButton("Clear", style=FluentButton.ButtonStyle.SUBTLE)
...
class FluentSortingMenu(QMenu):
    ...
    def _setup_menu(self):
        ...
        for field in self._fields:
            ...
            action.triggered.connect(lambda triggered=False, f=field_name: self._on_field_changed(f))
...
class FluentFilterProxyModel(QSortFilterProxyModel):
    ...
    def filterAcceptsRow(self, source_row: int, source_parent: QModelIndex) -> bool:
        ...
        if self._filter_columns:
            ...
            # Check all columns
            columns_to_check = range(self.sourceModel().columnCount(source_parent))
